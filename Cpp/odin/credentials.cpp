...
fostlib::json odin::app_credentials(
...
std::pair<fostlib::utf8_string, fostlib::timestamp> odin::renew_jwt(
        fostlib::string jwt,
        fostlib::string secret,
        const fostlib::json config) {
    fostlib::nullable<fostlib::jwt::token> jwt_token =
            fostlib::jwt::token::load(secret, jwt);
    ...
    fostlib::timestamp exp_timestamp = jwt_ob.expires(
            fostlib::coerce<fostlib::timediff>(config["expires"]), false);
