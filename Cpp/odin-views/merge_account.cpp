...
namespace {
    ...
    const class app_merge_user : public fostlib::urlhandler::view {
      public:
        app_merge_user() : view("odin.app.merge_user") {}

        // 1. read jwt from header
        // 2. read jwt from body
        // 3. check is body user already registered
        // 3.1. if registerd raise
        // 4. merge user
        // 5. return jwt
