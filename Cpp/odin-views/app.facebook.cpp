        ...
        std::pair<boost::shared_ptr<fostlib::mime>, int> operator()(
            ...
            return odin::thirdparty::login(
                ...
                [](auto &cnx, auto access_token) {
                    return odin::facebook::get_user_detail(cnx, access_token);
                },
                [](auto &cnx, auto const &facebook_user_id, auto const &app_id) {
                    return odin::facebook::app_credentials(cnx, facebook_user_id, app_id);
                },
                [](auto &cnx, auto reference, auto identity_id, auto facebook_user_id) {
                    return odin::facebook::set_facebook_credentials(cnx, reference, identity_id, facebook_user_id);
                }
            );
            ...
            // auto facebook_user = odin::facebook::app_credentials(cnx, facebook_user_id, app_id);
