      ...
      public:
        ...
        std::pair<boost::shared_ptr<fostlib::mime>, int> operator()(
            ...
            return odin::thirdparty::login(
                ...
                [](auto &cnx, auto const &google_user_id, auto const &app_id) {
                    return odin::google::app_credentials(cnx, google_user_id, app_id);
                },
                [](auto &cnx, auto reference, auto identity_id, auto google_user_id) {
                    return odin::google::set_google_credentials(cnx, reference, identity_id, google_user_id);
                }
            );
        //     if (req.method() != "POST") {
        //         fostlib::json config;
